...
var $author$project$Main$AddCircle = function (a) {
	return {$: 'AddCircle', a: a};
};
var $author$project$Circle$Circle = F3(
	function (position, color, radius) {
		return {color: color, position: position, radius: radius};
	});
var $author$project$Circle$Position = F2(
	function (x, y) {
		return {x: x, y: y};
	});
...
var $author$project$Circle$generatePosition = function (imageConfig) {
	return A3(
		$elm$random$Random$map2,
		$author$project$Circle$Position,
		A2($elm$random$Random$int, 0, imageConfig.width),
		A2($elm$random$Random$int, 0, imageConfig.height));
};
var $author$project$Circle$InternalColor = F3(
...
var $author$project$Circle$internalColorGenerate = A4(
	$elm$random$Random$map3,
	$author$project$Circle$InternalColor,
	A2($elm$random$Random$int, 0, 255),
	A2($elm$random$Random$int, 0, 255),
	A2($elm$random$Random$int, 0, 255));
var $author$project$Circle$generate = function (imageConfig) {
	return A4(
		$elm$random$Random$map3,
		$author$project$Circle$Circle,
		$author$project$Circle$generatePosition(imageConfig),
		$author$project$Circle$internalColorGenerate,
		A2($elm$random$Random$int, 5, 5));
};
...
var $author$project$ImageConfig$UpdateOpacity = function (a) {
	return {$: 'UpdateOpacity', a: a};
};
var $author$project$ImageConfig$UpdatePositionDelta = function (a) {
	return {$: 'UpdatePositionDelta', a: a};
};
var $author$project$ImageConfig$UpdateRadius = function (a) {
...
var $author$project$ImageConfig$init = function (_v0) {
	return {
		...
		opacity: 1,
		opacitySlider: $carwow$elm_slider$SingleSlider$init(
			{max: 1, min: 0, onChange: $author$project$ImageConfig$UpdateOpacity, step: 0.05, value: 1}),
		positionDelta: 5,
		...
		radius: 5,
		radiusSlider: $carwow$elm_slider$SingleSlider$init(
			{max: 100, min: 1, onChange: $author$project$ImageConfig$UpdateRadius, step: 1, value: 5}),
		width: 500
	};
};
var $author$project$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		...
		A2(
			...
			$author$project$Circle$generate(imageConfig)));
};
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				(model.paused || $elm$core$List$isEmpty(model.activeCircles)) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame(
				function (_v0) {
...
var $author$project$Main$step = F2(
	function (model, circleUpdate) {
		var _v0 = model.activeCircles;
		if (!_v0.b) {
			return model;
		} else {
			var hd = _v0.a;
			var tl = _v0.b;
			var updatedCircle = A3($author$project$Circle$updateCircle, model.imageConfig, circleUpdate, hd);
			return _Utils_update(
				model,
				{
					activeCircles: _Utils_ap(
						tl,
						_List_fromArray(
							[updatedCircle])),
					visibleCircles: A2(
		...
		switch (msg.$) {
			case 'UpdatePositionDelta':
				...
				return _Utils_update(
					...
					{
						positionDelta: value,
						positionDeltaSlider: A2($carwow$elm_slider$SingleSlider$update, value, imageConfig.positionDeltaSlider)
					});
			case 'UpdateMaxCircles':
				var new_value = msg.a;
				var value = $elm$core$Basics$round(new_value);
				return _Utils_update(
					imageConfig,
					{
						maxCircles: value,
						maxCirclesSlider: A2($carwow$elm_slider$SingleSlider$update, value, imageConfig.maxCirclesSlider)
					});
			case 'UpdateRadius':
				var new_value = msg.a;
				var value = $elm$core$Basics$round(new_value);
				return _Utils_update(
					...
					{
						radius: value,
						radiusSlider: A2($carwow$elm_slider$SingleSlider$update, value, imageConfig.radiusSlider)
					});
			default:
				var value = msg.a;
				return _Utils_update(
					...
					{
						opacity: value,
						opacitySlider: A2($carwow$elm_slider$SingleSlider$update, value, imageConfig.opacitySlider)
					});
		}
	});
...
var $author$project$Circle$fillColor = function (circle) {
	return $author$project$Circle$internalColorToCssColor(circle.color);
};
...
var $author$project$Main$pixels = function (model) {
	return A2(
		$elm$core$List$map,
		$author$project$Main$viewCircle(model.imageConfig),
		$elm$core$Array$toList(model.visibleCircles));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$carwow$elm_slider$SingleSlider$view(imageConfig.radiusSlider),
				$carwow$elm_slider$SingleSlider$view(imageConfig.opacitySlider)
			]));
};
